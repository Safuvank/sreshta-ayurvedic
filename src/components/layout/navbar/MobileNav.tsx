...
export const MobileNav = () => {
  ...
  return (
    <div className="lg:hidden flex items-center relative z-[101]">
      ...
      <button 
        onClick={() => setIsOpen(true)} 
        className="group flex items-center gap-3 px-5 py-2.5 bg-white/10 backdrop-blur-md border border-white/20 rounded-full text-white shadow-sm hover:bg-white/20 transition-all duration-300"
      >
