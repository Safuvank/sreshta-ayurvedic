...
//   return (
//     <div className="lg:hidden flex items-center">
//       {/* FIXED: The trigger button is now a normal, relative element matching the solid white navbar styling */}
//       <button
//         onClick={() => setIsOpen(!isOpen)}
//         className="relative flex items-center justify-center w-11 h-11 border border-gray-200 rounded-xl bg-white text-[#1F3D35] transition-colors hover:bg-gray-50"
//         aria-label={isOpen ? "Close menu" : "Open menu"}
//       >
//         <div className="flex flex-col items-end justify-center gap-[5px] w-5 h-4 relative">
//           <motion.span
...
//             exit={{ opacity: 0, y: "-100%" }}
//             transition={{ duration: 0.5, ease: [0.16, 1, 0.3, 1] }}
//             // FIXED: z-[100] places this just underneath the main Navbar (z-[110])
//             // pt-24 gives room so the links don't hide behind the navbar
//             className="fixed inset-0 w-full h-[100dvh] bg-white z-[100] flex flex-col pt-24 overflow-hidden"
//           >
//             {/* Scrollable Links Container */}
//             <div className="flex-1 overflow-y-auto px-4 md:px-8 py-4 flex flex-col gap-2 w-full">
//               {navigation.map((item) => (
//                 <div key={item.label} className="border-b border-gray-100 pb-2">
//                   {item.children ? (
//                     <div className="flex flex-col">
...
//             <div className="px-4 md:px-8 py-6 bg-[#FAFAFA] border-t border-gray-100 flex justify-center">
//               <div className="w-full">
//                 <button className="w-full flex items-center justify-center bg-[#0b2f25] text-white py-4 rounded-xl shadow-md font-medium text-base transition-none hover:bg-[#0b2f25] focus:outline-none">
//                   Book Consultation
//                 </button>
//               </div>
//             </div>
