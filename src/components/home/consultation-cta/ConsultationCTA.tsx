...
export const ConsultationCTA = () => {
  return (
    ...
    <section className="relative pb-7 lg:py-6 bg-[#FAFAFA] overflow-visible">
      <Container>
        ...
        <motion.div
          ...
          className="relative overflow-hidden rounded-2xl lg:rounded-2xl bg-[#1F3D35] px-6 py-10 md:py-12 lg:py-16 mt-5 shadow-2xl border border-white/10"
        >
