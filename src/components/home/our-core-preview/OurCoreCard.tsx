...
//                 : "text-gray-900 hover:text-[#2F5D50]"
//             }`}
//           >
//             {title}
//           </h3>
...
//         <p
//           className={`text-[14px] lg:text-[15px] leading-relaxed line-clamp-3 mb-4 ${
...
export const OurCoreCard = ({
  ...
  return (
    ...
    >
      {/* Top Image Container */}
      <Link href={`/our-core/${slug}`} className="relative w-full aspect-[4/3] block overflow-hidden bg-gray-100">
        <Image
          src={image}
          alt={title}
          fill
