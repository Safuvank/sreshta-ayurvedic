...
//     <article className={`flex flex-col gap-5 shrink-0 ${className}`}>
//       {/* Image Container */}
//       <div className="relative w-full aspect-[4/5] md:aspect-[16/9] rounded-2xl overflow-hidden bg-[#7a4f32]">
//         <Image
//           src={image}
//           alt={title}
//           fill
...
//       {/* Content */}
//       <div className="flex flex-col gap-3">
//         <h3 className="font-serif text-2xl md:text-[1.75rem] text-white leading-tight">
//           {title}
//         </h3>
        
//         <p className="text-[15px] text-white/80 leading-relaxed line-clamp-3 md:line-clamp-4">
//           {description}
//         </p>

//         {/* Updated Route Link with Complementary Gold/Beige */}
//         <Link
//           href={`/our-core/${slug}`}
//           className="group inline-flex items-center gap-2 text-[15px] font-medium text-[#EADBB6] transition-colors hover:text-white mt-1 w-fit"
//         >
//           Learn more
//           <ArrowRight className="w-4 h-4 transition-transform duration-300 ease-out group-hover:translate-x-1" />
//         </Link>
