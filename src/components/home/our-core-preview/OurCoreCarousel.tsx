...
//   return (
//     <section className="py-12 md:py-24 bg-[#895a3a] overflow-hidden">
//       <Container>
//         {/* Updated Heading Color */}
//         <h2 className="text-[2rem] md:text-5xl font-serif text-white mb-8 md:mb-16 text-center leading-tight">
//           Conditions supported <br className="block md:hidden" /> by Panchakarma
//         </h2>
...
//         {/* Updated Navigation Buttons for Dark Background */}
//         <div className="flex justify-start md:justify-center items-center gap-4 mt-6 md:mt-2 px-1">
//           <button
//             onClick={() => handleScroll("left")}
//             className="flex items-center justify-center w-10 h-10 md:w-11 md:h-11 rounded-full border border-white/40 text-white transition-colors hover:bg-white hover:text-[#895a3a]"
//             aria-label="Scroll left"
//           >
//             <ChevronLeft className="w-5 h-5" strokeWidth={1.5} />
//           </button>
