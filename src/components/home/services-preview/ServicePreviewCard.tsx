...
export const ServicePreviewCard = ({
  ...
  return (
    <article className="group relative flex h-full flex-col bg-white rounded-[2.5rem] p-3 transition-all duration-500 hover:shadow-[0_20px_40px_-15px_rgba(47,93,80,0.08)] border border-gray-100 hover:border-[#2F5D50]/20">
      ...
      <div className="flex flex-1 flex-col px-5 py-6 lg:px-6 lg:py-8">
        ...
        <div className="mt-8 flex items-center justify-between border-t border-gray-100 pt-6 transition-colors duration-300 group-hover:border-[#C9A86A]/30">
