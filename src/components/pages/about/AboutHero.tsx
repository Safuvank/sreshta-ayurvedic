...
export const AboutHero = () => {
  const paragraphText =
    "Sreshta Multi-Specialty Ayurveda Clinic is a premium Ayurveda center where the timeless wisdom of Ayurveda meets modern medical science, delivering authentic, holistic healthcare without compromising traditional principles.";
  ...
  return (
    <section className="relative py-16 md:py-24 lg:py-32 overflow-hidden pt-28 md:pt-32 min-h-[60vh] flex items-center">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0">
        {/* Removed the misplaced line element from here */}
