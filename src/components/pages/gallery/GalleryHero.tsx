...
export const GalleryHero = () => {
  const paragraphText =
    "Take a visual journey through our carefully curated environment, where traditional Kerala heritage meets modern comfort to support your holistic recovery.";
  ...
  return (
    <section className="relative py-16 md:py-24 lg:py-32 overflow-hidden pt-28 md:pt-32 min-h-[60vh] flex items-center">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          src="/images/gallery/gallery-hero.png" // Add your image path here
          alt="Healing spaces at Sreshta Ayurveda"
          fill
          ...
          <h1 className="font-serif text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-white leading-tight break-words">
            <span className="block overflow-hidden pb-2">
              <motion.span variants={wordVariants} className="block">
                Explore Our <span className="italic text-[#C9A86A]">Spaces</span>
              </motion.span>
            </span>
          </h1>
