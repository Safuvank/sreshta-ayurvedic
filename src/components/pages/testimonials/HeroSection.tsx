...
export const HeroSection = () => {
  const paragraphText = "Listen to the genuine experiences of individuals who found confidence, recovery, and wellness through our dedicated care.";
  ...
  return (
    <section className="relative py-16 md:py-24 lg:py-32 overflow-hidden pt-28 md:pt-32 min-h-[60vh] flex items-center">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          src="/images/testimonial/testimonial-hero.png" /* <-- Update with your hero image path */
          alt="Patient Stories - Sreshta Ayurveda"
          fill
      ...
      <Container className="relative z-10 w-full pb-16">
        <motion.div variants={containerVariants} initial="hidden" animate="show" className="max-w-3xl">
          ...
          <h1 className="font-serif text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-white leading-tight break-words">
            ...
            <span className="block overflow-hidden pb-2">
              <motion.span variants={wordVariants} className="block italic text-[#C9A86A]">
                Transformation
              </motion.span>
            </span>
          </h1>
