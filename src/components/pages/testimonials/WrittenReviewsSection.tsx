...
// export const WrittenReviewsSection = ({ reviews }: WrittenReviewsSectionProps) => {
//   return (
...
//                 <p>No written stories available for this treatment yet.</p>
//               </div>
//             )}
//           </AnimatePresence>
//         </motion.div>
...
export const WrittenReviewsSection = ({ reviews }: WrittenReviewsSectionProps) => {
  ...
  return (
    <section id="written-reviews" className="py-16 lg:py-24 bg-white border-t border-gray-100">
      <Container>
        {/* <div className="flex items-center justify-between mb-10">
          <div className="flex items-center gap-3">
            <MessageSquare className="w-6 h-6 text-[#C9A86A]" />
