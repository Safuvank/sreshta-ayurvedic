...
import { ArrowLeft, Leaf } from "lucide-react";
import { Container } from "@/src/components/common/Container";
// 2. Import the Modal (Adjust path if needed)
        ...
        <section className="py-16 lg:py-24 bg-[#F8F5EF]">
          <Container>
            <div className="bg-white p-10 md:p-16 rounded-3xl border border-gray-200 text-center max-w-3xl mx-auto shadow-sm">
              ...
              <button 
                onClick={() => setIsModalOpen(true)} // 4. Add onClick handler to empty state button
                className="bg-[#1F3D35] hover:bg-[#2F5D50] text-white px-8 py-4 rounded-xl transition-colors font-medium cursor-pointer"
              >
                Schedule a Consultation
              </button>
            </div>
