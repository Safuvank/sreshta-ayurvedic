        ...
        <motion.div variants={containerVariants} initial="hidden" animate="show" className="max-w-3xl">
          ...
          <h1 className="font-serif text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-white leading-tight break-words">
            <span className="block overflow-hidden pb-2">
              <motion.span variants={wordVariants} className="block">Comprehensive Ayurvedic Care </motion.span>
            </span>
            <span className="block overflow-hidden pb-2">
              <motion.span variants={wordVariants} className="block italic text-[#C9A86A]">for Every Health Concern</motion.span>
            </span>
          </h1>
